...
@AllArgsConstructor
@Entity
@Table(name = "metadatos_empleado", uniqueConstraints = {
                @UniqueConstraint(name = "uq_meta_empleado", columnNames = { "empleado_id", "clave" })
}, indexes = {
...
public class MetadatoEmpleado {
        ...
        @JoinColumn(name = "empleado_id", nullable = false, foreignKey = @ForeignKey(name = "fk_meta_empleado"))

...
public interface ReporteIncidenteRepository extends JpaRepository<ReporteIncidente, Long> {
    ...
    @Query("""
                ...
                LEFT JOIN FETCH r.tarea t
                LEFT JOIN FETCH t.empleado te LEFT JOIN FETCH te.usuario
                LEFT JOIN FETCH t.supervisor ts LEFT JOIN FETCH ts.usuario
                LEFT JOIN FETCH t.area ta
